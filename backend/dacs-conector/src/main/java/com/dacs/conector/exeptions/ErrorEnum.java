package com.dacs.conector.exeptions;

import org.springframework.http.HttpStatus;

public enum ErrorEnum implements IEnumError {
    ERROR_INESPERADO(1000,"dacs.messages.error.inesperado",HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    ERROR_API(1006,"dacs.messages.error.api",HttpStatus.INTERNAL_SERVER_ERROR);
